...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.whereami.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".whereami" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".whereami")
	}
